...
for (def i = 1; i <= SA; i++) {
    ...
    WebUI.callTestCase(findTestCase('500/Account and Deposit/TC_Create CASA - USD'), [('CIF') : CIF, ('CURRENCY') : CURRENCY, ('PRODUCT') : PRODUCT], 
...
for (def i = 1; i <= CA; i++) {
    ...
    WebUI.callTestCase(findTestCase('500/Account and Deposit/TC_Create CASA'), [('CIF') : CIF, ('CURRENCY') : CURRENCY, ('PRODUCT') : PRODUCT], 
        FailureHandling.STOP_ON_FAILURE)
