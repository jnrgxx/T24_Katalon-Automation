...
WebUI.waitForElementPresent(findTestObject('Object Repository/Teller Screen/Account and Deposit/Teller Menu', [('TellerMenu') : 'Peso Cash Deposit']), 
    3)

WebUI.click(findTestObject('Object Repository/Teller Screen/Account and Deposit/Teller Menu', [('TellerMenu') : 'Peso Cash Deposit']))

WebUI.waitForElementPresent(findTestObject('Object Repository/Teller Screen/Account and Deposit/Teller SubMenu', [('TellerSubMenu') : 'Peso Cash Deposit']), 
    10)

WebUI.click(findTestObject('Object Repository/Teller Screen/Account and Deposit/Teller SubMenu', [('TellerSubMenu') : 'Peso Cash Deposit']))
