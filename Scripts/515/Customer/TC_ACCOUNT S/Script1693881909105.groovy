...
WebUI.setText(findTestObject('Object Repository/3_Page_Input Command Value/inputCommand'), INPUT_COMMAND_LINE + ACCOUNT_NUMBER)
...
WebUI.takeFullPageScreenshot(RunConfiguration.getReportFolder() + '\\verified_customer.png')

System.out.println('Report saved to - ' + RunConfiguration.getReportFolder())

WebUI.delay(2)

WebUI.closeWindowTitle('ACCOUNT')
