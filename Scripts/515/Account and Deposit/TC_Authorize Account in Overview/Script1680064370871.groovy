...
String P1 = WebUI.getText(findTestObject('Object Repository/Service Manager Screen/Account and Deposit/Find/labelDescription'))
String P2 = PRODUCT

Result = WebUI.verifyMatch(P1, P2, false, FailureHandling.OPTIONAL)
