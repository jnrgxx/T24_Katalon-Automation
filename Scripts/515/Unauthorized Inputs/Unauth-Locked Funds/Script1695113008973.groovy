...
WebUI.setText(findTestObject('Teller Screen/Input Lock_Hold Funds/input_ACCOUNT.NUMBER_value311'), ACCOUNT_NUMBER)

WebUI.setText(findTestObject('Teller Screen/Input Lock_Hold Funds/input_LOCKED.AMOUNT_value711'), LOCK_AMOUNT)
